...
util.add_minable_result("simple-entity", "cerys-ruin-colossal", {type="item", name="bronze-plate", amount_min=5, amount_max=7})
util.add_minable_result("simple-entity", "cerys-ruin-huge", {type="item", name="bronze-plate", amount_min=4, amount_max=6})
